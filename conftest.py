...
class _StubSchema:
    """Minimal vol.Schema stub that preserves the dict for inspection."""
...
class _VolInvalid(Exception):
    """Stub for vol.Invalid so validators can raise a real exception."""


vol_mock.Schema = _StubSchema
...
# Set real string values on const mock so dict key matching works
