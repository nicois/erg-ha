...
PLATFORMS: list[str] = ["sensor", "binary_sensor", "calendar", "switch", "number", "select", "text", "button"]
...
def make_job_device_info(entity_id: str) -> dict:
    ...
    friendly = friendly_name(entity_id)
    return {
...
TARIFF_SOURCE_CHOICES = {
    "manual": "Manual (configure tariff periods)",
    "aemo": "AEMO Wholesale (NEM PREDISPATCH)",
}
