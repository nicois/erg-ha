...
async def async_get_action_capabilities(
    ...
    if action_type == "set_ev_charging":
        return {
            "extra_fields": vol.Schema(
                {
                    vol.Required("target_energy"): vol.Coerce(float),
                    vol.Optional("min_energy", default=0.0): vol.Coerce(float),
                    vol.Required("benefit"): vol.Coerce(float),
...
_ACTION_ATTR_MAP: dict[str, str | None] = {
    ...
    "set_ev_charging": None,  # handled specially
}
