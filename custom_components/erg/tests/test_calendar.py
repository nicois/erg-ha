...
class TestErgScheduleCalendar:
    ...
    def test_build_events_groups_contiguous_slots(self):
        ...
        assert "Runs 10:00" in events[0].description
        assert "Grid cost: $0.15" in events[0].description
        assert "Benefit: $1.50" in events[0].description
    ...
    def test_build_events_splits_on_gap(self):
        ...
        assert "[block 1/2]" in events[0].description
        ...
        assert "[block 2/2]" in events[1].description
