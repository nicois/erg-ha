...
from .const import DOMAIN, friendly_name, make_job_device_info, validate_duration, validate_time_str
...
def create_job_texts(
    ...
    texts.append(
        ErgJobText(
            job_entity, coordinator, entry_id, entity_id,
            attr="depends_on", suffix="depends_on", name_suffix="Depends On",
